...
const About = () => {
    return (
        <>
            <div className="py-40 bg-blue-200  flex justify-center items-center">
                ...
                <div className="px-4 lg:px-24 ">
                    ...
                    <p className=" mb-4 font-semibold text-lg mt-2">
                    ...
                    <div className="flex space-x-4 mt-4">
                        <a href="https://github.com/krishna-shrivastav232702" target="_blank" rel="noopener noreferrer">
                            <FaGithub className="h-6 w-6 text-gray-800 hover:text-black transition" />
                        </a>
